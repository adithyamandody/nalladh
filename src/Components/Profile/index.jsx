...
function Profile() {
  return (
    <div className='h-full w-full  flex flex-col flex-grow '>
      ...
      ></div>
      <div className='w-full  bg-teal-400 flex flex-col'>
        <div className='rounded-full w-20 h-20 bg-gray-300 -mt-10 mx-7 flex-shrink-0'></div>
      ...
      >
          <div className='w-full flex flex-grow absolute bottom-16 '>{new Array(8).fill(0).map(()=> {
            return <img className='w-12' src={trees[(Math.random() * trees.length) | 0]} />
        })}</div>
      </div>
